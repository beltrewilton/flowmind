defmodule FlowmindWeb.UserProfileLive do
  ...
  def render(assigns) do
    ...
    <div class="p-5">
      <.simple_form for={@form} id="customer-list-form" phx-submit="send" class="">
            ...
            <:item>
              <div>
                <img
                  ...
                  src={"https://i.pravatar.cc/150?u=#{customer.phone_number}"}
                />
              </div>
              <div>
              ...
              <.button shape="square" ghost>
                <.input
                  name="entry_form[customer_ids][]"
                  value={customer.id}
                  checked={!!customer.checked}
                  id={"inputs-checkbox-#{customer.id}"}
        ...
        <:actions>
          <div class="flex justify-end w-full">
            <.button
              ...
              color="primary"
              class="w-1/4 mt-4 hover:bg-blue-600 transition duration-300"
            >
              Save assigns <.icon name="hero-cloud-arrow-up" />
            </.button>
          </div>
        </:actions>
      </.simple_form>
