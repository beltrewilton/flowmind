defmodule Flowmind.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    field :email, :string
    field :name, :string
    field :role, Ecto.Enum, values: [:admin, :user, :employee], default: :user
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Flowmind.Repo)
  ...
  """
  def valid_password?(%Flowmind.Accounts.User{hashed_password: hashed_password}, password)
